...
MobileConnect supports Java 6 and above, and is dependent upon and Apache HTTP Client 4.5.2.  It uses the SLF-4J logging framework and is dependent upon SLF-4J 1.7.21.
