...
public class Scope
{
    ...
    public static final String MC_PHONE = "mc_identity_phonenumber";
    public static final String MC_SIGNUP = "mc_identity_signup";
    public static final String MC_NATIONALID = "mc_identity_nationalid";
